...
from breadbox.components.uart_6551.terminal.device import Uart6551Terminal
...
def resolve(
    ...
    return Uart6551Terminal(id=component_id, provider_device=provider_device, **device_settings)
